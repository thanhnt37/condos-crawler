...
$factory->define(App\Models\Philpropertyexpert::class, function (Faker\Generator $faker) {
    return [
        'id' => '',
        'title' => '',
        'postal_code' => '',
...
$factory->define(App\Models\Preselling::class, function (Faker\Generator $faker) {
    return [
        'id' => '',
        'title' => '',
        'postal_code' => '',
