...
class CreatephilpropertyexpertsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('philpropertyexperts', function (Blueprint $table) {
        ...
        $this->updateTimestampDefaultValue('philpropertyexperts', ['updated_at'], ['created_at']);
    }
    ...
    {
        Schema::dropIfExists('philpropertyexperts');
    }
}
