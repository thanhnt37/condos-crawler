...
class CreatezipmatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('zipmatches', function (Blueprint $table) {
        ...
        $this->updateTimestampDefaultValue('zipmatches', ['updated_at'], ['created_at']);
    }
    ...
    {
        Schema::dropIfExists('zipmatches');
    }
}
