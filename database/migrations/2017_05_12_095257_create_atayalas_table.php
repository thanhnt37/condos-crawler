...
class CreateatayalasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('atayalas', function (Blueprint $table) {
        ...
        $this->updateTimestampDefaultValue('atayalas', ['updated_at'], ['created_at']);
    }
