...
class Propertyasia extends Base
{
    ...
    protected $presenter = \App\Presenters\PropertyasiaPresenter::class;

    public static function boot()
    {
//        parent::boot();
//        parent::observe(new \App\Observers\PropertyasiaObserver);
    }
