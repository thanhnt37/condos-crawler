...
class Zipmatch extends Base
{
    ...
    protected $presenter = \App\Presenters\ZipmatchPresenter::class;

    public static function boot()
    {
//        parent::boot();
//        parent::observe(new \App\Observers\ZipmatchObserver);
    }
