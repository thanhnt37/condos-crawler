...
class Preselling extends Base
{
    ...
    protected $presenter = \App\Presenters\PresellingPresenter::class;

    public static function boot()
    {
//        parent::boot();
//        parent::observe(new \App\Observers\PresellingObserver);
    }
