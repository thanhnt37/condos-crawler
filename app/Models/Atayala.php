...
class Atayala extends Base
{
    ...
    protected $presenter = \App\Presenters\AtayalaPresenter::class;

    public static function boot()
    {
//        parent::boot();
//        parent::observe(new \App\Observers\AtayalaObserver);
    }
