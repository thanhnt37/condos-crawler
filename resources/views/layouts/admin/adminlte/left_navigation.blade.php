    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @if( $authUser->hasRole(\App\Models\AdminUserRole::ROLE_SUPER_USER) )
                ...
                <li @if( $menu=='buildings') class="active" @endif ><a href="{!! \URL::action('Admin\BuildingController@index') !!}"><i class="fa fa-file-word-o"></i> <span>Building</span></a></li>
            ...
            <li @if( $menu=='propertyasias') class="active" @endif ><a href="{!! \URL::action('Admin\PropertyasiaController@index') !!}"><i class="fa fa-users"></i> <span>Propertyasia</span></a></li>
            <!-- %%SIDEMENU%% -->
        </ul>
    </section>
    <!-- /.sidebar -->
